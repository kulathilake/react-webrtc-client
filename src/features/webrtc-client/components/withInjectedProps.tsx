...
import { WebRtcClientProps, WebRtcClientWrapperProps } from "../types";
 ...
 * @param Component 
 */
export default function withInjectedProps <P extends WebRtcClientProps>
(Component: React.ComponentType<P>):React.FC<Omit<P, keyof WebRtcClientWrapperProps>> {
